---
title: Awesome volleyball fundamentals video compilation
excerpt: "This post contains a list of volleyball fundamentals videos covering topics like warm up, passing, setting, serving and attack.
It's a compilation for future reference."
header:
...
permalink: /sport/awesome-volleyball-fundamentals-video-compilation
published: true
categories:
  - sport
tags:
...
To do sports is fun and healthy, but doing it right brings you more joy and satisfaction. This is also the case when playing volleyball, which I 
started doing again this summer at a local club - [awesome guys](https://volleyliebefeld.ch/#post-78) there.
Since it's been like an eternity, 20 years ago, when I last played "professionally", things got a little bit rusty and I needed a refresh.
As with most things in life I am an autodidact so I thought I checked some youtube videos created by professionals, which show basic but very important 
techniques in volleyball. I created this public video compilation to use as reference for later. I play as a setter and opposite right hand attacker
...
> Some of this material I wish I knew 20 years ago, but it's never too late to learn something new, is it?
...
2. it improve performance by preparing sport specific muscles needed in training or match, and thus have more fun

> In the following exercises I found myself warming up before trainings and games in high school... Ahh it brings up such 
nice memories. Really if you want to do something for your kid bring have her join a team sports club.

 
### How to WARMUP for Volleyball - Volleyball Tutorial - 9min
...
What you should take from the following video is the length of it. You should warm up at least 15min before touching the ball.
...
### Volleyball tips: Passing techniques with John Speraw - YouTube 8min
...
### Right Side Spiking FOOTWORK - How to SPIKE a Volleyball Tutorial - 6min
...
### Right Side / Opposite Hitter Spiking TECHNIQUE - How to SPIKE a Volleyball Tutorial - 9min
...
## Appendix
Well now since you know the basics, it's now time to move up a scale and enjoy
